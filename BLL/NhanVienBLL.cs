...
namespace BLL
{
    public class NhanVienBLL
    {
        ...
        public bool InsertNV(int id, string tennhanvien, DateTime ngaysinh, int IdLoainhanvien, string sodienthoai, string cmnd, string email, string gioitinh, string diachi)
        {
