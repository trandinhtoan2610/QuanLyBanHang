...

{
    public partial class Nhanvien : UserControl
    {
        ...
        public void addNhanVienBinding()
        {
            ...
            //rb1.DataBindings.Add(new Binding("Checked", dtaGVNV.DataSource, "gioitinh", true, DataSourceUpdateMode.Never));
            //rb2.DataBindings.Add(new Binding("Checked", dtaGVNV.DataSource, "gioitinh", true, DataSourceUpdateMode.Never));
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (qlnvBLL.UpdateNV(nv.Id, nv.Tennhanvien, nv.Ngaysinh, nv.IdLoainhanvien, nv.Sodienthoai, nv.Cmnd, nv.Email,nv.Gioitinh, nv.Diachi))
            {
